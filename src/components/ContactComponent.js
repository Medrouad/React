...
class Contact extends Component {
    ...
    validate(firstname, lastname, telnum, email) {
        ...
        if(this.state.touched.telnum && !reg.test(telnum)) {
            errors.telnum = 'Tel Number shoud be a number';
        }

        if(this.state.touched.email && email.split('').filter((s) => s === '@').length === 0) {
                    ...
                    <div className="col-12 col-md-9">
                        ...
                        <FormGroup row>
                            <Col md={{size:6, offset:2}}>
                                <FormGroup>
                                    <Label check>                                 
                                        <Input type="checkbox" name="agree" checked={this.state.agree} value={this.state.email} onChange={this.handleInputChange} />
